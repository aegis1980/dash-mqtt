...
- incoming (dict; optional): Incoming message"""
    @_explicitize_args
    def __init__(self, state=Component.UNDEFINED, broker_url=Component.UNDEFINED, protocol=Component.UNDEFINED, broker_port=Component.UNDEFINED, options=Component.UNDEFINED, topics=Component.UNDEFINED, id=Component.UNDEFINED, message=Component.UNDEFINED, incoming=Component.UNDEFINED, **kwargs):
        self._prop_names = ['state', 'broker_url', 'protocol', 'broker_port', 'options', 'topics', 'id', 'message', 'incoming']
        self._type = 'DashMqtt'
        self._namespace = 'dash_mqtt'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['state', 'broker_url', 'protocol', 'broker_port', 'options', 'topics', 'id', 'message', 'incoming']
